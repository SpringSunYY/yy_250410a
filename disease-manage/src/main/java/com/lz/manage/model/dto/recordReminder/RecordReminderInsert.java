...
public class RecordReminderInsert implements Serializable {
     ...
     * 对象转封装类
     *
     * @param recordReminderInsert 插入对象
     * @return RecordReminderInsert
     */
    public static RecordReminder insertToObj(RecordReminderInsert recordReminderInsert) {
        if (recordReminderInsert == null) {
            return null;
        }
        RecordReminder recordReminder = new RecordReminder();
        BeanUtils.copyProperties(recordReminderInsert, recordReminder);
