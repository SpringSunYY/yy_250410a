  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="medicalRecordList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="病历编号" align="center" v-if="columns[0].visible" prop="recordId" />
        <el-table-column label="所属用户" :show-overflow-tooltip="true" align="center" v-if="columns[1].visible" prop="userId" />
        <el-table-column label="使用模板" :show-overflow-tooltip="true" align="center" v-if="columns[2].visible" prop="templateId" />
        <el-table-column label="病历标题" :show-overflow-tooltip="true" align="center" v-if="columns[3].visible" prop="recordTitle" />
        ...
        <el-table-column label="病历内容" :show-overflow-tooltip="true" align="center" v-if="columns[5].visible" prop="content" />
        ...
        <el-table-column label="所属部门" :show-overflow-tooltip="true" align="center" v-if="columns[7].visible" prop="deptId" />
        ...
        <el-table-column label="是否共享" align="center" v-if="columns[10].visible" prop="isShared">
        <template slot-scope="scope">
...
<script>
import { listMedicalRecord, getMedicalRecord, delMedicalRecord, addMedicalRecord, updateMedicalRecord } from "@/api/manage/medicalRecord";
    ...
    return {
      ...
      columns: [
        { key: 0, label: '病历编号', visible: true },
          ...
          { key: 10, label: '是否共享', visible: true },
